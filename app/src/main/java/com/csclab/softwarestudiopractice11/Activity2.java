        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch(event.getAction()){
                ...
                case MotionEvent.ACTION_MOVE: //ACTION_MOVE
                    ...
                    int xToMinus = v.getWidth();
                    int yToMinus = v.getHeight();
                    v.layout((int)(x + mx) - xToMinus, (int)(y + my) - yToMinus, (int)(x + mx + v.getWidth()) - xToMinus, (int)(y + my + v.getHeight()) - yToMinus);
